        ...
        >
          <div className="max-w-screen-xl w-full mx-auto flex flex-col items-center justify-center mt-4 md:mt-16 mb-4 md:mb-12 px-0 sm:px-4">
            ...
            <Tabs value={tab} onValueChange={setTab}>
              <TabsList className="flex min-w-[400px] sm:min-w-0 flex-nowrap justify-start sm:justify-center gap-1 md:gap-2 mt-2 bg-[#1e293b]/50 backdrop-blur-md rounded-xl p-1 border border-[#334155] shadow-lg overflow-x-auto max-w-2xl mx-auto">
