...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className={`flex-1 min-h-screen transition-all duration-300 md:${sidebarHovered ? 'ml-64' : 'ml-8'} w-full px-0`}>
        <div className="w-full mt-10 md:mt-16 mb-6 md:mb-12">
